...
// Hero images
import heroImage1 from '@/assets/hero-furniture.jpg';
import heroImage2 from '@/assets/1.jpg';
import heroImage3 from '@/assets/2.jpg';
import heroImage4 from '@/assets/3.jpg';
  ...
  return (
    <div className="min-h-screen bg-gradient-warm font-poppins">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        {/* Overlay gradient */}
        <div className="absolute inset-0 bg-gradient-to-r from-primary/80 to-primary/40 transition-opacity duration-1000"></div>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-indigo-50 to-purple-50 overflow-hidden">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="relative w-full overflow-hidden">
            <div className="scroll-container" style={{ gap: '2rem' }}>
